...
; RUN:   && %raise_cli %t.hsaco --target-isa=gfx942 --emit-ir=vopd_extra_subops_kernel 2>/dev/null | %FileCheck %s
;
...
vopd_extra_subops_kernel:
	...
	s_wait_loadcnt 0x0
	;;#ASMSTART
	v_dual_mov_b32 v2, 1.0 :: v_dual_ashrrev_i32 v3, 31, v1
	;;#ASMEND
	s_clause 0x1
	global_load_b32 v1, v5, s[0:1] scale_offset
	global_load_b32 v4, v6, s[0:1] scale_offset
	s_wait_loadcnt 0x0
	;;#ASMSTART
	v_dual_mov_b32 v5, v1 :: v_dual_max_i32 v4, 0, v4
	;;#ASMEND
