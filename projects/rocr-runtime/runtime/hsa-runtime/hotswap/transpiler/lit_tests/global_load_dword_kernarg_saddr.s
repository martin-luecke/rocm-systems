...
; kernarg segment address rather than a sentinel.  GPT-OSS
...
; the source's `global_load_b32 ..., s[0:1] offset:2` lowers to a regular
; GEP+load against an addrspace(1) pointer reconstructed from the kernarg
; segment pointer — not as a literal load from address 0x2 or via a
; provenance fast path.
