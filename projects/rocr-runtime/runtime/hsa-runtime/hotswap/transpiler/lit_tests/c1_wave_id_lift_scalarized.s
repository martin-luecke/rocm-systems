...
; RUN:   && %not %raise_cli %t.hsaco --target-isa=gfx942 --emit-ir=c1_wave_id_lift_scalarized_kernel 2>&1 | %FileCheck %s --check-prefix=REFUSE
;
; RUN: %llvm_mc -mcpu=gfx1250 %s -o %t.o && %ld_lld -shared %t.o -o %t.hsaco \
; RUN:   && %raise_cli %t.hsaco --target-isa=gfx942 --enable-writelane-rewrite --emit-ir=c1_wave_id_lift_scalarized_kernel 2>/dev/null | %FileCheck %s --check-prefix=REWRITTEN
;
...
; %bb.0:
	...
	;;#ASMEND
	;;#ASMSTART
	v_writelane_b32 v1, s1, 0
	
	;;#ASMEND
	v_dual_mov_b32 v26, 0 :: v_dual_bitop2_b32 v1, s1, v1 bitop3:0x14
	s_add_co_i32 s2, s2, 1
	s_and_b32 s3, ttmp6, 15
	s_mul_i32 s2, ttmp9, s2
	s_wait_kmcnt 0x0
	s_clause 0x5
	global_load_b128 v[2:5], v26, s[4:5]
	global_load_b128 v[10:13], v26, s[6:7]
	global_load_b128 v[14:17], v26, s[6:7] offset:16
	global_load_b128 v[22:25], v26, s[8:9] offset:16
	global_load_b128 v[6:9], v26, s[4:5] offset:16
	global_load_b128 v[18:21], v26, s[8:9]
	s_wait_xcnt 0x1
	...
	s_clause 0x1
	global_store_b128 v26, v[18:21], s[8:9]
	global_store_b128 v26, v[22:25], s[8:9] offset:16
