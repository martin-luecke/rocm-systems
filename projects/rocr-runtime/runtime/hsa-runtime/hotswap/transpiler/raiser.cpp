...
RaiseResult raiseToIR(llvm::ArrayRef<uint8_t> textBytes,
                      ...
                      bool enableWritelaneRewrite,
                      bool enableWaveNative) {
  std::vector<uint8_t> textBytesVec(textBytes.begin(), textBytes.end());
  return raiseToIRImpl(textBytesVec, sourceISA.str(), kernelName.str(), meta,
                       kernelOffset, compilationTargetISA.str(),
